...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::email::disconnect_email,
            commands::email::list_important_emails,
            commands::email::list_all_important_emails,
            commands::email::open_email,
            commands::email_oauth::start_email_oauth,
            commands::email_mailapp::list_mail_accounts,
            commands::email_mailapp::use_mail_account,
            commands::email_mailapp::open_internet_accounts,
